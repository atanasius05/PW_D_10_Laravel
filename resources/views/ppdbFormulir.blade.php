...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="text-center flex-grow-1">
                <span class="navbar-text text-white" style="font-size: 1.5rem;">
                    Formulir PPDB SMAK ST. AUGUSTINUS KEDIRI
                </span>
            </div>
        </div>
    </nav>
    ...
    <section class="container my-2 w-50 bg-white text-dark p-5 mt-5 "
        ...
        <form class="row g-3" action="{{ route('pendaftaran-siswas.create') }}" method="POST"
            enctype="multipart/form-data">
            @csrf
            <div class="col-12">
                <label for="inputNama" class="form-label" style="font-weight: bold;">Nama Lengkap</label>
                <input type="text" class="form-control" id="inputNama" name="nama" placeholder="Tulis Nama Lengkap"
                    required>
            </div>
            <div class="col-md-6">
                <label for="inputNISN" class="form-label" style="font-weight: bold;">NISN</label>
                <input type="text" class="form-control" id="inputNISN" name="nisn" placeholder="Masukkan NISN" required>
            </div>
            <div class="col-md-6">
                <label for="inputJenisKelamin" class="form-label" style="font-weight: bold;">Jenis Kelamin</label>
                <select id="inputJenisKelamin" class="form-select" name="jenis_kelamin" required>
            ...
            <div class="col-md-6">
                <label for="inputAlamat" class="form-label" style="font-weight: bold;">Alamat</label>
                <input type="text" class="form-control" id="inputAlamat" name="alamat" placeholder="Tulis Alamat"
                    required>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                <label for="inputAgama" class="form-label" style="font-weight: bold;">Agama</label>
                <select id="inputAgama" class="form-select" name="agama" required>
                    <option hidden></option>
            ...
            <div class="col-12">
                <label for="inputAsalSekolah" class="form-label" style="font-weight: bold;">Asal Sekolah</label>
                <input type="text" class="form-control" id="inputAsalSekolah" name="asal_sekolah"
                    placeholder="Tulis Asal Sekolah" required>
            </div>
            <div class="col-12">
                <label for="autoSizingInputGroupEmail" class="form-label" style="font-weight: bold;">Email</label>
                <div class="input-group">
                    <div class="input-group-text">@</div>
                    <input type="email" class="form-control" id="autoSizingInputGroupEmail" name="email"
            ...
            <div class="col-12">
                <label for="inputProfilePic" class="form-label" style="font-weight: bold;">Foto Profil</label>
                <input type="file" class="form-control" id="inputProfilePic" name="profilePic">
            </div>
            <div class="col-12">
            ...
            <div class="col-12">
                <button type="submit" class="btn btn-success" onclick="redirectToLogin()">Daftar</button>
            </div>
        </form>
    ...
    <script>
        function redirectToLogin() {
            // Mengubah nilai input hidden menjadi "login" sebelum formulir disubmit
            document.getElementById('redirectTo').value = "login";
        }
    </script>
</body>
